...
@php $siteSettings = app(\App\Settings\SiteSettings::class); @endphp
    <div class="mx-auto max-w-screen-xl px-4 py-10 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div class="lg:col-span-2">
                <a href="{{ url('/') }}" class="flex items-center gap-3 mb-4">
                    <img src="{{ asset('build/images/logo.png') }}" class="h-9" alt="{{ config('app.name') }}" />
            ...
            {{-- Open Source column --}}
            <div>
                <h2 class="mb-4 text-xs font-semibold tracking-widest text-neutral-500 uppercase">Open Source</h2>
                <ul class="space-y-2 text-sm text-neutral-400">
                    <li>
                        <a href="https://github.com/liberusoftware" target="_blank" rel="noopener noreferrer"
                           class="hover:text-[#f5c518] transition-colors">GitHub Repositories</a>
                    </li>
                    <li>
                        <a href="https://liberu.co.uk" target="_blank" rel="noopener noreferrer"
                           class="hover:text-[#f5c518] transition-colors">liberu.co.uk</a>
                    </li>
                    <li>
                        <a href="{{ url('/') }}" class="hover:text-[#f5c518] transition-colors">Home</a>
                    </li>
                </ul>
            </div>
            ...
            {{-- Contact column --}}
            <div>
                <h2 class="mb-4 text-xs font-semibold tracking-widest text-neutral-500 uppercase">Contact</h2>
                <ul class="space-y-2 text-sm text-neutral-400">
                    ...
                    <li>
                        <a href="tel:{{ $siteSettings->site_phone }}" class="hover:text-[#f5c518] transition-colors">
                    ...
                    <li>
                        <a href="mailto:{{ $siteSettings->site_email }}" class="hover:text-[#f5c518] transition-colors">
        ...
        <div class="flex flex-col items-center gap-6 sm:flex-row sm:justify-between">
            <span class="text-sm text-neutral-500 text-center sm:text-left" title="{{ config('app.version') }}">
                {{ $siteSettings->footer_copyright ?? ('© ' . now()->year . ' ' . ($siteSettings->site_name ?? config('app.name')) . '. All Rights Reserved.') }}
            </span>
