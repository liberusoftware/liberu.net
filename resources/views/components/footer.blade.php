    ...
    <div class="mx-auto max-w-screen-xl">
        <div class="md:flex md:justify-between">
            <div class="mb-6 md:mb-0">
                <a href="{{ url('/') }}" class="flex items-center">
                    ...
                    <span class="self-center text-xl sm:text-2xl font-semibold whitespace-nowrap dark:text-white">
                        {{ $siteSettings->site_name ?? config('app.name') }} </span>
                </a>
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-6 md:grid-cols-3">
                ...
                <div>
                    ...
                    <span class="text-xs text-gray-600 block">{{ $siteSettings->site_address ?? '' }}</span>
                    <span class="text-xs text-gray-600 block">{{ $siteSettings->site_phone ?? '' }}</span>
                    <span class="text-xs text-gray-600 block">{{ $siteSettings->site_email ?? '' }}</span>
                </div>
            </div>
        </div>
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            ...
            <div class="flex mt-4 space-x-4 sm:space-x-6 sm:justify-center sm:mt-0">
                ...
                <a href="{{ $siteSettings->github_url }}"
                    class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        <path fill-rule="evenodd"
